...
ggplot(outliers_calle, aes(número_outliers, calle)) +  geom_point()
...
#Mediante un diagrama de puntos.
ggplot(df, aes(Nombre_calle, valor)) + geom_point(alpha = 0.05, col = "blue" ) + coord_flip()  + geom_hline(yintercept = sol_sigma[3], col = "red", linetype = 1) + geom_hline(yintercept = sol_sigma[4], , col = "blue", linetype = 1) + geom_hline(yintercept = sol_sigma[1], , col = "green", linetype = 2) + theme_bw()

#Mediante diagrama de violin.
ggplot(df, aes(Nombre_calle, valor)) +  geom_violin() + coord_flip() + theme(axis.text = element_text(size = 7)) + geom_hline(yintercept = sol_sigma[3]) + geom_hline(yintercept = sol_sigma[4])+ geom_hline(yintercept = sol_sigma[1], , col = "green", linetype = 2)  + theme_bw()
