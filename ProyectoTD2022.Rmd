...
packages=c("tidyverse", "knitr", "ggplot2", "datasets", "RColorBrewer", "dplyr", "readr", "tidyr","lubridate","gganimate","plotly","png","ggpubr","colorspace")
...
## Preguntas a reponder en el proyecto
  ...
  2. ¿Hay alguna calle que exceda en algún momento los estándares impuestos en la ley estatal de ruido?
